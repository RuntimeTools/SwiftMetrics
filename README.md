...
### SwiftMetrics.emitData(ofType: String, _: Any)
Allows you to emit custom Data specifying the type of Data as a string. Data to pass into the event must be cast as an Any object using 'as Any'.
